...
def learn(alpha=.1/numTilings, epsilon=0, numEpisodes=1):
    theta1 = -0.001*rand(n)
    theta2 = -0.001*rand(n)
    returnSum = 0.0
    for episodeNum in range(numEpisodes):
        ...
        while (state):
            ...
            # implement Double-Q learning, need two Qs, each Q has three possible actions
            ...
            if (num>=epsilon):
                for possibleAction in range(0,3):
                    ...
                    for index in tileIndices: # implementing the vector multiplication thetaT*phi
                        ...
                        #print(q1,q2)
                    '''
                    q1 = Qs(tileIndices, theta1)
                    q2 = Qs(tileIndices, theta2)
            ...
            if nextState==None:
                ...
                if np.random.randint(0,2): # with 0.5 probability
                    ...
                    print('??: ', action*numTiles+nextTileIndices)
                    #print('nextQ1: ', nextQ1)
